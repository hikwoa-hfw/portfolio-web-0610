        ...
        <div className="container flex mx-auto justify-between items-center py-4">
          ...
          <Dialog>
            ...
            <DialogContent className="w-[425px]">
              <DialogHeader>
                <DialogTitle className="text-teal-700 text-2xl font-bold">Contact Me</DialogTitle>
              ...
              <div className="flex flex-col gap-4 justify-items-center">
                {linkData.map((item, index) => (
                  <Link href={item.link} legacyBehavior passHref key={index}>
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center p-3 transition-all duration-150 hover:border-teal-700 hover:border-[2px] hover:rounded-lg hover:shadow-green"
                    >
                      {item.icon}
